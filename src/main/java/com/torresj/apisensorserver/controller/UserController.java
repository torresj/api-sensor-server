...
public class UserController {
    ...
    public ResponseEntity<Page<User>> getUsers(
        ...
        try {
            logger
                    .info("[USER - GET ALL] Getting users with filter {}, role{}, page {}, elements {} by user \"{}\"", filter,
                            role, nPage,
            ...
            logger
                    .info(
                            "[USER - GET ALL] Request for getting users with filter {}, role {}, page {}, elements {} finished by user \"{}\"",
                            filter, role,
                            nPage,
                            elements, principal.getName());
